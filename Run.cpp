...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	// 画像を読み込む
	imgHorse[RED] = LoadGraph("image/赤馬1.png");
	imgHorse[BLUE] = LoadGraph("image/青馬1.png");
	imgHorse[BLACK] = LoadGraph("image/黒馬1.png");
	imgHorse[WHITE] = LoadGraph("image/白馬1.png");

	imgHorse2[RED1] = LoadGraph("image/赤馬1.png");
	imgHorse2[RED2] = LoadGraph("image/赤馬2.png");
	imgHorse2[RED3] = LoadGraph("image/赤馬3.png");
	imgHorse2[BLUE1] = LoadGraph("image/青馬1.png");
	imgHorse2[BLUE2] = LoadGraph("image/青馬2.png");
	imgHorse2[BLUE3] = LoadGraph("image/青馬3.png");
	imgHorse2[BLACK1] = LoadGraph("image/黒馬1.png");
	imgHorse2[BLACK2] = LoadGraph("image/黒馬2.png");
	imgHorse2[BLACK3] = LoadGraph("image/黒馬3.png");
	imgHorse2[WHITE1] = LoadGraph("image/白馬2.png");
	imgHorse2[WHITE2] = LoadGraph("image/白馬2.png");
	...
	while (1) // メインループ
	{
		...
		case BED:
			...
			DrawText(400, 100, 0x000000, "+100円", 0, 50);
			DrawText(400, 300, 0x000000, "-100円", 0, 50);
			DrawText(600, 100, 0x000000, "+500円", 0, 50);
			DrawText(600, 300, 0x000000, "-500円", 0, 50);
			DrawText(800, 100, 0x000000, "+1000円", 0, 50);
			DrawText(800, 300, 0x000000, "-1000円", 0, 50);
			DrawText(1000, 100, 0x000000, "+5000円", 0, 50);
			DrawText(1000, 300, 0x000000, "-5000円", 0, 50);
			DrawText(1200, 100, 0x000000, "+10000円", 0, 50);
			DrawText(1200, 300, 0x000000, "-10000円", 0, 50);
